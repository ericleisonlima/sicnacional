...
class SystemUserForm extends TPage
{
    ...
    function __construct()
    {
        ...
        $program_id        = new TDBSeekButton( 'program_id', 'dbsic', 'form_System_user', 'SystemProgram', 'name', 'program_id', 'program_name' );
        $program_name      = new TEntry( 'program_name' );
        $groups            = new TDBCheckGroup( 'groups','dbsic','SystemGroup','id','name' );
        $medico_id         = new TDBSeekButton( 'medico_id', 'dbsic', 'form_System_user', 'MedicoRecord', 'nome', 'medico_id', 'medico_nome' );
        $medico_nome       = new TEntry( 'medico_nome' );
        // $unit_id             = new TDBCombo( 'system_unit_id','dbsic','SystemUnit','id','name' );
        ...
        $medico_id->setSize( '60' );
        $medico_nome->setSize( 'calc(38% - 60px)' );
        // $unit_id->setSize('38%');
        ...
        $medico_id->addValidation( _t( 'Profissional' ), new TRequiredValidator );

        $this->form->addFields( [ new TLabel( 'Profissional' ) ], [ $medico_id, $medico_nome ] );
    ...
    function onEdit( $param )
    {
        try {
            ...
            if ( isset( $param['key'] ) ) {
                ...
                $object->medico_nome = $object->nome;
                unset( $object->password );

...
class TipoMedicamentoList extends TPage
{
    ...
    public function __construct()
    {
        ...
        $this->form = new BootstrapFormBuilder( "form_list_tipomedicamento" );
        $this->form->setFormTitle( "Listagem de Tipos de Medicamentos" );
        ...
        $this->form->addAction( "Novo", new TAction( [ "TipoMedicamentoForm", "onEdit" ] ), "bs:plus-sign green" );
        ...
        $action_edit = new TDataGridAction(array('TipoMedicamentoForm', 'onEdit'));

...
class TipoNutricaoList extends TPage
{
    ...
    public function __construct()
    {
        ...
        $this->form = new BootstrapFormBuilder( "form_list_cadastro_tiponutricao" );
        $this->form->setFormTitle( "Listagem de Tipos de Nutri&ccedil;&atilde;o" );
        ...
        $this->form->addAction( "Novo", new TAction( [ "TipoNutricaoForm", "onEdit" ] ), "bs:plus-sign green" );

...
class TipoAdminMedicamentoList extends TPage
{
    private $form;
    private $datagrid;
    ...
    public function __construct()
    {
        ...
        $this->form = new BootstrapFormBuilder( "form_list_tipoadminmedicamento" );
        $this->form->setFormTitle( "Listagem de Administração de Medicamento." );
        ...
        $this->form->addAction( "Novo", new TAction( [ "TipoAdminMedicamentoForm", "onEdit" ] ), "bs:plus-sign green" );
        ...
        $action_edit = new TDataGridAction( [ "TipoAdminMedicamentoForm", "onEdit" ] );
    ...
    function Delete( $param = NULL )
    {
        ...
        {
            TTransaction::open( "dbsic" );
            $object = new descricao( $param[ "key" ] );
            $object->delete();
            TTransaction::close();
            $this->onReload();

...
class CadastroMedicoList extends TPage
{
    ...
    public function __construct()
    {
        ...
        $this->form = new BootstrapFormBuilder( "form_list_cadastro_Medico" );
        ...
        $opcao->addItems( [ "nome" => "Nome", "crm" => "Crm", "celular" => "Celular" ] );
        ...
        $this->form->addAction( "Novo", new TAction( [ "CadastroMedicoForm", "onEdit" ] ), "bs:plus-sign green" );
        ...
        $order_crm = new TAction( [ $this, "onReload" ] );
        $order_crm->setParameter( "order", "crm" );
        $column_crm->setAction( $order_crm );
      
      
        //Criacao da acao de edicao no datagrid
        $action_edit = new TDataGridAction( [ "CadastroMedicoForm", "onEdit" ] );
    ...
    public function onSearch()
    {
        ...
        try
        {
            if( !empty( $data->opcao ) && !empty( $data->dados ) )
            {
                ...
                else if ( ( $data->opcao == "crm" || $data->opcao == "celular" ) && ( is_numeric( $data->dados ) ) )
                {
                    $criteria->add( new TFilter( $data->opcao, "LIKE", $data->dados . "%" ) );
                }
                else

...
class AnamneseForm extends TPage
{
    ...
    public function __construct()
    {
        ...
        $id               = new THidden( "id" );
        $estabelecimento_medico_id             = new TLabel( "estabelecimento_medico_id" );
        ...
        $comprimentointestinodelgado           = new TEntry( "comprimentointestinodelgado" );
        $larguraintestinodelgado            = new TEntry( "larguraintestinodelgado" );
        ...
        $this->form->addAction( "Voltar para a listagem", new TAction( [ "AnamneseList", "onReload" ] ), "fa:table blue" );
        //Criacao do container que recebe o formulario
        $container = new TVBox();
        $container->style = "width: 90%";
        $container->add( new TXMLBreadCrumb( "menu.xml", "AnamneseList" ) );
    ...
    public function onSave()
    {
        try
        {
            ...
            $object->store();
            TTransaction::close();
            $action = new TAction( [ "AnamneseList", "onReload" ] );
